		...
		super.mExecute(pDiscordBot, message, args)
			...
			(
				() => 
				{
					...
					let vEconomy = pDiscordBot.Database.Economy.mGetEconomy(message.guild.id, vUser.id);
					...
					let vParticipation = pDiscordBot.Database.Participations.mGetParticipations
					(
						message.guild.id,
						vUser.id
					);
